...
use healpix_geo::vectorized::ring::coordinates as vectorized;
...
pub(crate) fn healpix_to_cartesian<'py>(
    ...
    let (x, y, z): (Vec<f64>, Vec<f64>, Vec<f64>) =
        vectorized::healpix_to_cartesian(ipix_.as_slice()?, &nside, &ellipsoid, nthreads as usize)
            .unzip3();
...
pub(crate) fn cartesian_to_healpix<'py>(
    ...
    let ipix = vectorized::cartesian_to_healpix(&coords, &nside, &ellipsoid, nthreads as usize);
...
pub(crate) fn bilinear_interpolation<'py>(
    ...
    let (ipix, weights): (Vec<Vec<u64>>, Vec<Vec<f64>>) =
        vectorized::bilinear_interpolation(&coords, &nside, &ellipsoid, nthreads as usize)
            .into_iter()
...
pub(crate) fn angular_distances<'py>(
    ...
    use healpix_geo::vectorized::ring::distances as vectorized;
