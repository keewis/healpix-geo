...
use healpix_geo::vectorized::nested::coordinates as vectorized;
...
pub(crate) fn healpix_to_cartesian<'py>(
    ...
    let (x, y, z): (Vec<f64>, Vec<f64>, Vec<f64>) =
        vectorized::healpix_to_cartesian(ipix_.as_slice()?, layer, &ellipsoid, nthreads as usize)
            .unzip3();
...
pub(crate) fn angular_distances<'py>(
    ...
    use healpix_geo::vectorized::nested::distances as vectorized;
